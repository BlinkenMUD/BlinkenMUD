...
char *
add_map_char (CHAR_DATA * ch, int x, int y, int x_pos, int y_pos)
{
  ...
  if (pRoom == NULL)
	...
	return room_wall;
      ...
      //Pretty up fields and large halls by removing unsightly corners.
      else if ((pExit = pRoom->exit[DIR_NORTH]) != NULL
	       && pExit->u1.to_room != NULL
	       && !IS_SET (pExit->exit_info, EX_ISDOOR)
	       && !IS_SET (pExit->exit_info, EX_HIDDEN)
	       && (pExit = pRoom->exit[DIR_WEST]) != NULL
	       && pExit->u1.to_room != NULL
	       && !IS_SET (pExit->exit_info, EX_ISDOOR)
	       && !IS_SET (pExit->exit_info, EX_HIDDEN)
	       ...
	       && !IS_SET (pExit->exit_info, EX_ISDOOR)
	       && !IS_SET (pExit->exit_info, EX_HIDDEN)
	       && (pExit = xRoom->exit[DIR_NORTH]) != NULL
	       && pExit->u1.to_room != NULL
	       && !IS_SET (pExit->exit_info, EX_ISDOOR)
	       && !IS_SET (pExit->exit_info, EX_HIDDEN)
	       ...
	       && !IS_SET (pExit->exit_info, EX_ISDOOR)
	       && !IS_SET (pExit->exit_info, EX_HIDDEN)
	       && (pExit = yRoom->exit[DIR_WEST]) != NULL
	       && pExit->u1.to_room != NULL
	       && !IS_SET (pExit->exit_info, EX_ISDOOR)
	       && !IS_SET (pExit->exit_info, EX_HIDDEN))
	return room_floor;
	...
	return room_wall;
      ...
      //Pretty up fields and large halls by removing unsightly corners.
	       ...
	       && !IS_SET (pExit->exit_info, EX_ISDOOR)
	       && !IS_SET (pExit->exit_info, EX_HIDDEN)
	       && (pExit = pRoom->exit[DIR_EAST]) != NULL
	       && pExit->u1.to_room != NULL
	       && !IS_SET (pExit->exit_info, EX_ISDOOR)
	       && !IS_SET (pExit->exit_info, EX_HIDDEN)
	       ...
	       && !IS_SET (pExit->exit_info, EX_ISDOOR)
	       && !IS_SET (pExit->exit_info, EX_HIDDEN)
	       && (pExit = yRoom->exit[DIR_EAST]) != NULL
	       && pExit->u1.to_room != NULL
	       && !IS_SET (pExit->exit_info, EX_ISDOOR)
	       && !IS_SET (pExit->exit_info, EX_HIDDEN))
	return room_floor;
	...
	return room_wall;
      ...
      //Pretty up fields and large halls by removing unsightly corners.
      else if ((pExit = pRoom->exit[DIR_SOUTH]) != NULL
	       && pExit->u1.to_room != NULL
	       && !IS_SET (pExit->exit_info, EX_ISDOOR)
	       && !IS_SET (pExit->exit_info, EX_HIDDEN)
	       && (pExit = pRoom->exit[DIR_WEST]) != NULL
	       ...
	       && !IS_SET (pExit->exit_info, EX_ISDOOR)
	       && !IS_SET (pExit->exit_info, EX_HIDDEN)
	       && (pExit = xRoom->exit[DIR_SOUTH]) != NULL
	       && pExit->u1.to_room != NULL
	       && !IS_SET (pExit->exit_info, EX_ISDOOR)
	       && !IS_SET (pExit->exit_info, EX_HIDDEN)
      ...
      for (door = 0; door < MAX_MAP_DIR; door++)
	{
	  if ((pexit = pRoom->exit[door]) != NULL
	      ...
	      if (!fSearch)
		{
	      ...
	      if (fSearch
		  || map[x + rev_dirs[door][0]][y + rev_dirs[door][1]] != 0)
		continue;
...
char *
format_map_desc (char *oldstring)
{
