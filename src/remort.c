...
void do_remort( CHAR_DATA *ch, char *argument )
{
	...
	else
	{
	    ...
	    send_to_char( "{WYou have chosen to {rremort{W.  You will now be dropped in at the race\n\r", ch );
    ...
    send_to_char("Typing '{yremort stop{x' [or any other argument] will undo remort status.\n\r",
	ch );
